...
林悦：「评委第一眼看到的就是界面。不求华丽，但要清晰、流畅、无 bug。」

**今日在 NexusAgent 主线中的位置**：毕业项目用户界面
...
Phase 6：毕业设计阶段第 63 天教学任务，与 NexusAgent 主线项目对齐。
...
**验收标准**：
- [ ] 代码可本地运行
- [ ] 通过 `scripts/verify_day.py --day 63`
...
| +60min | 完成全部文件并自测 | `python3` 运行通过 | 使用 `scripts/verify_day.py --day 63` |
| +90min | 提交 Git 并建 MR | MR 关联 Jira NEXUS-607 | 按附录 Git 示例操作 |
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/README.md`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 README.md.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/requirements.txt`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 requirements.txt.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/__init__.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 __init__.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/main.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 main.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/docs/PROJECT_PROPOSAL.md`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 PROJECT_PROPOSAL.md.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/docker-compose.dev.yml`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 docker-compose.dev.yml.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/auth/__init__.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 __init__.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/auth/models.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 models.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/auth/service.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 service.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/auth/router.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 router.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/rag/__init__.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 __init__.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/rag/ingest.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 ingest.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/rag/retriever.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 retriever.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/rag/router.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 router.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/agent/__init__.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 __init__.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/agent/graph.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 graph.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/agent/router.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 router.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/api/__init__.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 __init__.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/api/middleware.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 middleware.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/api/router.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 router.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/main_integrated.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 main_integrated.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/frontend/index.html`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 index.html.py`（若为包内模块则按课件说明）
...
**操作步骤**：
1. 在 `courseware/day-63/code/` 下创建文件 `graduation_project/nexus_capstone/app/static_mount.py`
2. 完整粘贴下方代码
3. 在终端执行：`cd courseware/day-63/code && python3 static_mount.py`（若为包内模块则按课件说明）
...
在企业级 Python 开发与大模型应用工程中，**聊天 UI 设计** 是学员必须牢固掌握的基本功。智链科技 Nexus 项目组在 Day 63 的代码评审中，特别强调以下几点：

1. **为什么学**：聊天 UI 设计 直接服务于后续 NexusAgent 平台的 `NEXUS-E6` 模块。没有扎实的 聊天 UI 设计，Day 70 之后调用 API、解析 JSON、编写 Agent 工具函数时会出现大量低级错误。
...
3. **企业实践**：在 SmartLink 的 GitLab 仓库中，所有与 聊天 UI 设计 相关的代码必须经过 Ruff 静态检查；变量命名使用 `snake_case`，常量使用 `UPPER_SNAKE_CASE`。

4. **与主线项目的关系**：今日代码位于 `courseware/day-63/code/`，部分模块将逐步合并到 `platform/nexus_agent/`。请养成「每日代码皆可运行、皆可测试」的习惯。

5. **扩展阅读建议**：完成今日作业后，可阅读 `docs/project-master-plan.md` 中关于 NEXUS-E6 的章节，建立全局视角。

**课堂互动题**：请用 3 句话向非技术同事解释「聊天 UI 设计」是什么。写在作业 MR 的评论里，讲师会抽查点评。

**实操检查清单**：
- [ ] 能不看课件复述 聊天 UI 设计 的定义
- [ ] 能独立写出相关代码并运行
- [ ] 能向同学讲解一处容易写错的地方
...
在企业级 Python 开发与大模型应用工程中，**Fetch API 调用** 是学员必须牢固掌握的基本功。智链科技 Nexus 项目组在 Day 63 的代码评审中，特别强调以下几点：

1. **为什么学**：Fetch API 调用 直接服务于后续 NexusAgent 平台的 `NEXUS-E6` 模块。没有扎实的 Fetch API 调用，Day 70 之后调用 API、解析 JSON、编写 Agent 工具函数时会出现大量低级错误。
...
3. **企业实践**：在 SmartLink 的 GitLab 仓库中，所有与 Fetch API 调用 相关的代码必须经过 Ruff 静态检查；变量命名使用 `snake_case`，常量使用 `UPPER_SNAKE_CASE`。

4. **与主线项目的关系**：今日代码位于 `courseware/day-63/code/`，部分模块将逐步合并到 `platform/nexus_agent/`。请养成「每日代码皆可运行、皆可测试」的习惯。

5. **扩展阅读建议**：完成今日作业后，可阅读 `docs/project-master-plan.md` 中关于 NEXUS-E6 的章节，建立全局视角。

**课堂互动题**：请用 3 句话向非技术同事解释「Fetch API 调用」是什么。写在作业 MR 的评论里，讲师会抽查点评。

**实操检查清单**：
- [ ] 能不看课件复述 Fetch API 调用 的定义
- [ ] 能独立写出相关代码并运行
- [ ] 能向同学讲解一处容易写错的地方
...
在企业级 Python 开发与大模型应用工程中，**静态文件挂载** 是学员必须牢固掌握的基本功。智链科技 Nexus 项目组在 Day 63 的代码评审中，特别强调以下几点：

1. **为什么学**：静态文件挂载 直接服务于后续 NexusAgent 平台的 `NEXUS-E6` 模块。没有扎实的 静态文件挂载，Day 70 之后调用 API、解析 JSON、编写 Agent 工具函数时会出现大量低级错误。
...
3. **企业实践**：在 SmartLink 的 GitLab 仓库中，所有与 静态文件挂载 相关的代码必须经过 Ruff 静态检查；变量命名使用 `snake_case`，常量使用 `UPPER_SNAKE_CASE`。

4. **与主线项目的关系**：今日代码位于 `courseware/day-63/code/`，部分模块将逐步合并到 `platform/nexus_agent/`。请养成「每日代码皆可运行、皆可测试」的习惯。

5. **扩展阅读建议**：完成今日作业后，可阅读 `docs/project-master-plan.md` 中关于 NEXUS-E6 的章节，建立全局视角。

**课堂互动题**：请用 3 句话向非技术同事解释「静态文件挂载」是什么。写在作业 MR 的评论里，讲师会抽查点评。
...
在企业级 Python 开发与大模型应用工程中，**用户体验** 是学员必须牢固掌握的基本功。智链科技 Nexus 项目组在 Day 63 的代码评审中，特别强调以下几点：

1. **为什么学**：用户体验 直接服务于后续 NexusAgent 平台的 `NEXUS-E6` 模块。没有扎实的 用户体验，Day 70 之后调用 API、解析 JSON、编写 Agent 工具函数时会出现大量低级错误。
...
3. **企业实践**：在 SmartLink 的 GitLab 仓库中，所有与 用户体验 相关的代码必须经过 Ruff 静态检查；变量命名使用 `snake_case`，常量使用 `UPPER_SNAKE_CASE`。

4. **与主线项目的关系**：今日代码位于 `courseware/day-63/code/`，部分模块将逐步合并到 `platform/nexus_agent/`。请养成「每日代码皆可运行、皆可测试」的习惯。

5. **扩展阅读建议**：完成今日作业后，可阅读 `docs/project-master-plan.md` 中关于 NEXUS-E6 的章节，建立全局视角。

**课堂互动题**：请用 3 句话向非技术同事解释「用户体验」是什么。写在作业 MR 的评论里，讲师会抽查点评。
...
在企业级 Python 开发与大模型应用工程中，**演示视频录制** 是学员必须牢固掌握的基本功。智链科技 Nexus 项目组在 Day 63 的代码评审中，特别强调以下几点：

1. **为什么学**：演示视频录制 直接服务于后续 NexusAgent 平台的 `NEXUS-E6` 模块。没有扎实的 演示视频录制，Day 70 之后调用 API、解析 JSON、编写 Agent 工具函数时会出现大量低级错误。
...
3. **企业实践**：在 SmartLink 的 GitLab 仓库中，所有与 演示视频录制 相关的代码必须经过 Ruff 静态检查；变量命名使用 `snake_case`，常量使用 `UPPER_SNAKE_CASE`。

4. **与主线项目的关系**：今日代码位于 `courseware/day-63/code/`，部分模块将逐步合并到 `platform/nexus_agent/`。请养成「每日代码皆可运行、皆可测试」的习惯。

5. **扩展阅读建议**：完成今日作业后，可阅读 `docs/project-master-plan.md` 中关于 NEXUS-E6 的章节，建立全局视角。

**课堂互动题**：请用 3 句话向非技术同事解释「演示视频录制」是什么。写在作业 MR 的评论里，讲师会抽查点评。
...
今天是 **Phase 6：毕业设计** 的第 **3** 个学习日。请回顾：
...
**代码量统计（累计）**：完成今日后，个人仓库累计约 **88200** 行（含注释与测试），全营目标 10 万行。

**明日预告**：请提前阅读 `courseware/day-64/README.md` 开头的旁白，了解上下文。
...
**Q1：学习「聊天 UI 设计」时最常问的问题是什么？**

A：学员常问「这在大模型开发里到底用在哪里」。直接回答：在 NexusAgent 的 `NEXUS-E6` 中，聊天 UI 设计 用于支撑「毕业设计开发：前端界面」这一交付。建议你打开 `platform/` 对照看未来模块如何引用今日写法。另一个常见问题是「要不要背语法」——不需要背，但要能写出可运行代码，并能在报错时读懂 Traceback。

**追问**：如果线上报错与 聊天 UI 设计 相关，如何排查？  
**答**：① 复现 ② 最小化输入 ③ 打印中间变量 ④ 查 GitLab 历史 diff ⑤ 在 Jira 建 Bug 单附上日志。


**Q2：学习「Fetch API 调用」时最常问的问题是什么？**

A：学员常问「这在大模型开发里到底用在哪里」。直接回答：在 NexusAgent 的 `NEXUS-E6` 中，Fetch API 调用 用于支撑「毕业设计开发：前端界面」这一交付。建议你打开 `platform/` 对照看未来模块如何引用今日写法。另一个常见问题是「要不要背语法」——不需要背，但要能写出可运行代码，并能在报错时读懂 Traceback。

**追问**：如果线上报错与 Fetch API 调用 相关，如何排查？  
**答**：① 复现 ② 最小化输入 ③ 打印中间变量 ④ 查 GitLab 历史 diff ⑤ 在 Jira 建 Bug 单附上日志。


**Q3：学习「静态文件挂载」时最常问的问题是什么？**

A：学员常问「这在大模型开发里到底用在哪里」。直接回答：在 NexusAgent 的 `NEXUS-E6` 中，静态文件挂载 用于支撑「毕业设计开发：前端界面」这一交付。建议你打开 `platform/` 对照看未来模块如何引用今日写法。另一个常见问题是「要不要背语法」——不需要背，但要能写出可运行代码，并能在报错时读懂 Traceback。

**追问**：如果线上报错与 静态文件挂载 相关，如何排查？  
**答**：① 复现 ② 最小化输入 ③ 打印中间变量 ④ 查 GitLab 历史 diff ⑤ 在 Jira 建 Bug 单附上日志。


**Q4：学习「用户体验」时最常问的问题是什么？**

A：学员常问「这在大模型开发里到底用在哪里」。直接回答：在 NexusAgent 的 `NEXUS-E6` 中，用户体验 用于支撑「毕业设计开发：前端界面」这一交付。建议你打开 `platform/` 对照看未来模块如何引用今日写法。另一个常见问题是「要不要背语法」——不需要背，但要能写出可运行代码，并能在报错时读懂 Traceback。

**追问**：如果线上报错与 用户体验 相关，如何排查？  
**答**：① 复现 ② 最小化输入 ③ 打印中间变量 ④ 查 GitLab 历史 diff ⑤ 在 Jira 建 Bug 单附上日志。


**Q5：学习「演示视频录制」时最常问的问题是什么？**

A：学员常问「这在大模型开发里到底用在哪里」。直接回答：在 NexusAgent 的 `NEXUS-E6` 中，演示视频录制 用于支撑「毕业设计开发：前端界面」这一交付。建议你打开 `platform/` 对照看未来模块如何引用今日写法。另一个常见问题是「要不要背语法」——不需要背，但要能写出可运行代码，并能在报错时读懂 Traceback。

**追问**：如果线上报错与 演示视频录制 相关，如何排查？  
**答**：① 复现 ② 最小化输入 ③ 打印中间变量 ④ 查 GitLab 历史 diff ⑤ 在 Jira 建 Bug 单附上日志。
...
1. **聊天 UI 设计**：请结合 NexusAgent 项目举例说明你在哪一天、哪段代码里用到了它？
2. **Fetch API 调用**：请结合 NexusAgent 项目举例说明你在哪一天、哪段代码里用到了它？
3. **静态文件挂载**：请结合 NexusAgent 项目举例说明你在哪一天、哪段代码里用到了它？
4. **用户体验**：请结合 NexusAgent 项目举例说明你在哪一天、哪段代码里用到了它？
5. **演示视频录制**：请结合 NexusAgent 项目举例说明你在哪一天、哪段代码里用到了它？

**参考答案思路**：采用 STAR 法则（情境-任务-行动-结果），引用 `courseware/day-63/code/` 中的具体文件名与函数名。
...
**今日重点审查项**：毕业设计开发：前端界面 相关逻辑是否可读、可测、可扩展至 `platform/nexus_agent/`。
...
完成可交互的聊天前端界面，能发送消息并显示 Agent 回复。提交界面截图和演示视频链接。

### 提交要求

1. 代码提交到分支 `feature/day-63-homework`
2. GitLab MR 标题：`[Day-63] homework: 课后作业`
...
fetch POST /api/v1/agent/chat，渲染用户/机器人消息气泡。StaticFiles 挂载 frontend/ 到根路径。
...
git checkout -b feature/day-63-毕业设计开发：前端界
# 完成代码后
git add courseware/day-63/
git commit -m "feat(day-63): 毕业设计开发：前端界面"
git push -u origin feature/day-63-毕业设计开发：前端界
```

---

*课件版本 Day-63-v1.0 | 智链科技培训中心*
